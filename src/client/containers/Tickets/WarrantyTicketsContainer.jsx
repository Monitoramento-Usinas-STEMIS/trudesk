...
@observer
class WarrantyTicketsContainer extends React.Component {
                        ...
                        {!this.props.loading && this.props.tickets.size < 1 && (
                            <TableRow clickable={false}>
                                <TableCell colSpan={10}>
                                    <h5 style={{ margin: 10 }}>No Warranty Tickets Found</h5>
                                </TableCell>
                            </TableRow>
                        )}
...
WarrantyTicketsContainer.propTypes = {
