        ...
        <form className={'uk-form-stacked'} onSubmit={e => this.onFormSubmit(e)}>
          ...
          <div className={'uk-margin-medium-bottom uk-clearfix'}>
            <div className='uk-float-left'>
              <h4 style={{ paddingLeft: 2 }}>Access all current and new customer enterprises?</h4>
            </div>
          ...
          <div className={'uk-margin-medium-bottom uk-clearfix'}>
            <div className='uk-float-left'>
              <h4 style={{ paddingLeft: 2 }}>Access all current and new public enterprises?</h4>
            </div>
          ...
          <div className={'uk-margin-medium-bottom'}>
            <label style={{ marginBottom: 5 }}>Customer Enterprises</label>
            <MultiSelect
              items={mappedGroups}
              onChange={() => {}}
