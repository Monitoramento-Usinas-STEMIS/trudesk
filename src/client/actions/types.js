...
export const FETCH_TICKET_ERROR_TYPES = defineAction('FETCH_TICKET_ERROR_TYPES', [SUCCESS, PENDING, ERROR])
...
export const GET_ERROR_TYPES_WITH_PAGE = defineAction('GET_ERROR_TYPES_WITH_PAGE', [SUCCESS, ERROR])
export const TAGS_UPDATE_CURRENT_PAGE = defineAction('TAGS_UPDATE_CURRENT_PAGE', [SUCCESS, ERROR])
export const ERROR_TYPES_UPDATE_CURRENT_PAGE = defineAction('ERROR_TYPES_UPDATE_CURRENT_PAGE', [SUCCESS, ERROR])
export const CREATE_TAG = defineAction('CREATE_TAG', [SUCCESS, ERROR])
export const CREATE_ERROR_TYPE = defineAction('CREATE_ERROR_TYPE', [SUCCESS, ERROR])
